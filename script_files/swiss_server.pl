...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{SWISS_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{SWISS_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
swiss_server.pl - Catalyst Testserver

=head1 SYNOPSIS

swiss_server.pl [options]
